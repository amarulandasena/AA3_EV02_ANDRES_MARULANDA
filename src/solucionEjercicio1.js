...
const Ejercicio1 = () => {
    ...
    while (true) {
        ...
        if (opcion == 1) { /** Perímetro del tríangulo. */
            ...
            alert("Área triángulo = " + area.toFixed(2) + " centimetros cuadrados."); /**  */
            ...
            alert("Área del rectángulo = " + area.toFixed(2) + " centimetros cuadrados.");
            ...
            alert("Perímetro del cuadrado = " + perimetro.toFixed(2) + " centimetros.");
            ...
            alert("Área del cuadrado = " + area.toFixed(2) + " centimetros cuadrados.");

        } else if (opcion == 7) { /** Perímetro del círculo. */
            let radio = parseFloat(prompt("Ingrese el radio del círculo en cm: "));

            let perimetro = 2 * Math.PI * radio;
            alert("El perímetro del círculo es= " + perimetro.toFixed(2) + " centimetros.");
